...
pub async fn build_router(
    ...
    let app = app
        ...
        .route(
            ...
            axum::routing::get(uni_agent::get_agent_builtin_tools_config)
                .put(routes::set_agent_tools),
        )
        .route(
        ...
        .route(
            ...
            axum::routing::patch(uni_agent::patch_agent_config),
        )
        .route(
        ...
        .route(
            "/api/clawhub/install",
            axum::routing::post(uni_skill::clawhub_install),
        )
        // Hands endpoints
        ...
        .route(
            "/api/mcp/servers",
            axum::routing::get(routes::list_mcp_servers).put(routes::update_mcp_servers),
        )
        .route(
            "/api/mcp/servers",
            axum::routing::delete(routes::delete_mcp_server),
        )
        // Audit endpoints
        .route(
            "/api/audit/recent",
    ...
    let app = app
        ...
        .route(
            "/unigpt/provider",
            axum::routing::post(crate::unigpt::patch_provider),
        )
