...
use openfang_types::model_catalog::{
    ...
    REPLICATE_BASE_URL, SAMBANOVA_BASE_URL, SUB2API_BASE_URL, TOGETHER_BASE_URL, VLLM_BASE_URL, XAI_BASE_URL,
...
/// Auto-detect an available provider by scanning environment variables.
/// Returns (provider_id, default_model, env_var_name) if found.
pub fn detect_available_provider() -> Option<(&'static str, &'static str, &'static str)> {
    // Priority order: popular cloud providers first, then others
    let providers: &[(&str, &str, &str)] = &[
        ...
        ("sub2api", "gpt-5.3-codex", "SUB2API_API_KEY"),
