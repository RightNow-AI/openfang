...
use crate::usage::SurrealUsageStore;
...
impl openfang_types::session::SessionPersistence for MemorySubstrate {
...
mod tests {
    ...
    async fn test_connect_in_memory() {
        let substrate = MemorySubstrate::connect_in_memory().await.unwrap();
