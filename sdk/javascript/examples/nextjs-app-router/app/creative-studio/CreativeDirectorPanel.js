  ...
  return (
    <div data-cy="director-panel" style={{ display: 'flex', flexDirection: 'column', gap: 0, height: '100%', minHeight: 0 }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 12, paddingBottom: 8, minHeight: 200 }}>
        {messages.length === 0 && (
          <div style={{ padding: '40px 0', textAlign: 'center', color: 'var(--text-dim,#888)' }}>
        ...
        {isThinking && (
          <div style={{ padding: '12px 16px', borderRadius: 10, background: 'var(--surface2,#1a1a2e)', border: '1px solid var(--border,#333)', maxWidth: 220, alignSelf: 'flex-start' }}>
            <span style={{ color: 'var(--text-dim,#888)', fontSize: 13 }}>Director is thinking…</span>
          </div>
        )}
        <div ref={bottomRef} />
      </div>
      ...
      {/* Composer */}
      <div style={{ borderTop: '1px solid var(--border,#333)', paddingTop: 16, flexShrink: 0 }}>
